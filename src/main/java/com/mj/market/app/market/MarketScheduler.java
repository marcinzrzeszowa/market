...
@Component
public abstract class MarketScheduler {
    ...
    @Autowired
    public MarketScheduler(String apiName, PriceAlertService priceAlertService, SymbolService symbolService, UserAlertNotifier userNotifier) {
        this.name = apiName;
