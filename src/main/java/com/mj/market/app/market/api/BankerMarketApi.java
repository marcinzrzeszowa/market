...
@Component
@Qualifier("BankerMarketApi")
public class BankerMarketApi extends MarketScheduler implements MarketApi{


    private record RawAttribute(String name, String startReqex, String endRegex){}

    private static final EnumSet<SymbolType> handledSymbols = EnumSet.of(SymbolType.WALUTA);
   ...
   // public static final String GOLD ="https://www.bankier.pl/inwestowanie/profile/quote.html?symbol=ZLOTO";
    ...
    public BankerMarketApi(PriceAlertService priceAlertService, SymbolService symbolService, UserAlertNotifier userNotifier) {
